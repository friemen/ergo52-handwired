...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN1] = LAYOUT(
    ...
    TG(_CAPS), KC_F11,    KC_F12,    _______,   _______,  OSL(_TEXT), _______,   _______,   KC_UP,     KC_PGUP,   KC_PGDN,   CTL_PLUS, \
  ...
  [_BRACKETS] = LAYOUT(
    ...
    _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   KC_LBRC,   KC_RBRC,   KC_EQL,    _______, \
    _______,   _______,   _______,   _______,   _______,   _______,   _______,   KC_HASH,   KC_LCBR,   KC_RCBR,   KC_MINS,   _______, \
    _______,   _______,   _______,   _______,   _______,   _______,   _______,   KC_UNDS,   KC_LT,     KC_GT,     _______,   _______, \
                                                _______,   _______,   _______,   _______ \
  ),
