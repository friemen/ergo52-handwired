...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN] = LAYOUT(
    ...
    _______,   KC_BRIU,   _______,   CTL_MINS,  _______,   _______,   KC_HOME,   KC_LEFT,   KC_DOWN,   KC_RIGHT,  KC_END,    KC_ENT,  \
    RESET,     KC_BRID,   _______,   KC_MPRV,   KC_MPLY,   KC_MNXT,   KC_HOME,   KC_END,    KC_VOLD,   KC_VOLU,   KC_MUTE,   TG(_NAV), \
                                                _______,   _______,   _______,   _______  \
  ),
  ...
  [_SYM] = LAYOUT(
    ...
    _______,   KC_COLN,   KC_TILD,   KC_DQUO,   KC_MINS,   KC_DOT,    _______,   KC_MINS,   KC_LPRN,   KC_RPRN,   KC_MINS,   KC_QUOT, \
    _______,   KC_SCLN,   KC_BSLS,   KC_QUOT,   KC_UNDS,   KC_QUES,   _______,   KC_UNDS,   KC_LT,     KC_GT,     KC_SLSH,   _______, \
                                                _______,   _______,   _______,   _______ \
  ),
